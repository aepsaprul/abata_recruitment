    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            ...
            <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                ...
                <li class="nav-item">
                    <a href="{{ route('register') }}" class="btn btn-outline-primary" style="width: 100px;">Register</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('login') }}" class="btn bg-gradient-primary ml-3" style="width: 100px;">Login</a>
                </li>
            </ul>
            </div>
        </nav>
