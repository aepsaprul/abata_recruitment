        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <div class="social-auth-links text-center mt-4 mb-3">
                    ...
                    <span class="text-info text-uppercase font-weight-bold"></span>
                </div>
                <!-- /.social-auth-links -->
                <hr>
                <div class="text-center mb-2 text-secondary" style="font-size: 14px;">©2022 All Rights Reserved - Abata</div>
            </div>
            <!-- /.card-body -->
        </div>
    </div>
